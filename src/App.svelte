...
<footer>
  ...
  <section>
    <h3>Features</h3>
    <ul>
      <li><button>Employee Management</button></li>
      <li><button>Attendance Tracking</button></li>
      <li><button>Payroll Processing</button></li>
      <li><button>Reports & Analytics</button></li>
    </ul>
  </section>
